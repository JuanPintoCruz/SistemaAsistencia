          ...
          <table class="w-full table-auto border-collapse border border-gray-300">
            <thead>
              <tr class="bg-gray-100">
                ...
                <th class="border border-gray-300">Foto </th>
                ...
                <th class="border border-gray-300">Fecha de ingreso</th>
                <th class="border border-gray-300">Teléfono</th>
                <th class="border border-gray-300">PUESTO</th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="t in trabajadores" :key="t.N_ID_TRABAJADOR" class="hover:bg-gray-50">
                ...
                <td class="border border-gray-300 px-4 py-2">
                  <div class="font-medium">{{ t.NOMBRES }} {{ t.APELLIDO_PATERNO }} {{ t.APELLIDO_MATERNO }}</div>
                </td>
                                
                <td class="border border-gray-300 px-4 py-2">
                  <div>no hay foto aun xd </div>
                </td>
