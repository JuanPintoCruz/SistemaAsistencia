    ...
    data() {
        return {
            ...
            menuItems: [
                ...
                { id: 3, name: 'Área 2', icon: 'bx bx-bar-chart-square', type: 'menu-item-dropdown', active: false, subMenu: [{ id: 1, name: 'Sub-Area1'}, { id: 2, name: 'Sub-Area2'}, { id: 3, name: 'Sub-Area3'}]},
                { id: 4, name: 'Informes', icon: 'bx bx-task', type: 'menu-item-static', active: false, subMenu: null},
                { id: 5, name: 'archivos', icon: 'bx bx-file-blank', type: 'menu-item-dropdown', active: false, subMenu: [{ id: 1, name: 'Images' }, { id: 2, name: 'Audios' }]},
            ]
        };
    },
    methods: {
